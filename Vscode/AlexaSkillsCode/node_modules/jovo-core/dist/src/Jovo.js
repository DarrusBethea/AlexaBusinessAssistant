...
class Jovo extends events_1.EventEmitter {
    constructor(app, host, handleRequest) {
        ...
        this.$type = {
            optional: true,
            type: enums_1.EnumRequestType.UNKNOWN_REQUEST,
        };
        this.$inputs = {};
        this.$output = {};
     ...
     */
    endSession() {
        Log_1.Log.info('endSession() is obsolete in v2');
    }
    /**
     ...
     */
    isLaunchRequest() {
        return this.$type.type === enums_1.EnumRequestType.LAUNCH;
    }
    /**
     ...
     */
    isIntentRequest() {
        return this.$type.type === enums_1.EnumRequestType.INTENT;
    }
    /**
     ...
     */
    isEndRequest() {
        return this.$type.type === enums_1.EnumRequestType.END;
    }
    /**
    ...
    isAudioPlayerRequest() {
        return this.$type.type === enums_1.EnumRequestType.AUDIOPLAYER;
    }
    /**
    ...
    isElementSelectedRequest() {
        return this.$type.type === enums_1.EnumRequestType.ON_ELEMENT_SELECTED;
    }
    /**
    ...
    parseForValidator(validator, inputName, input, failedValidators) {
        // tslint:disable-line:no-any
        try {
            if (validator instanceof validators_1.Validator) {
                ...
                throw new JovoError_1.JovoError('This validation type is not supported.', JovoError_1.ErrorCode.ERR, 'jovo-core', undefined, 'Please make sure you only use supported types of validation such as a function or an extended Validator', '');
            }
        }
        catch (err) {
            if (err.constructor === validators_1.ValidationError) {
