...
import { ASRData, Host, Inputs, JovoData, JovoRequest, JovoResponse, JovoSession, NLUData, Output, RequestType, SessionAttributes, SessionData } from './Interfaces';
...
export declare abstract class Jovo extends EventEmitter {
     ...
     * @return {*}
     */
    getInput(key: string): import("./Interfaces").Input;
    /**
     * Sets output object
     * @public
     * @param {Output} obj
