...
export declare function config(cfg?: AppConfig): AppConfig;
declare global {
    interface Console {
        /**
...
export { Component, ComponentConfig, ComponentDelegationOptions, ComponentResponse, ComponentResponseStatus, } from './plugins/Component';
